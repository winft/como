...
class ExpoLayout : public QQuickItem
{
    ...
    Q_PROPERTY(PlacementMode placementMode READ placementMode WRITE setPlacementMode NOTIFY
                   placementModeChanged)
    Q_PROPERTY(bool ready READ isReady NOTIFY readyChanged)
    /**
     * Stop binary search when the two candidate strip widths are within tol (as a fraction of the
     * larger strip width). Default is 0.2.
     */
    Q_PROPERTY(qreal searchTolerance MEMBER m_searchTolerance NOTIFY searchToleranceChanged)
    /**
     * The ideal sum of window widths in a strip (including added margins), as a fraction of the
     * strip width. *MUST* be strictly less than 1. Default is 0.8.
     */
     ...
     */
    Q_PROPERTY(
        qreal relativeMarginLeft MEMBER m_relativeMarginLeft NOTIFY relativeMarginLeftChanged)
    /**
     * Right margin size, as a ratio of the short side of layout area. Default is 0.07.
     * The margins are added to each window before layout.
     */
    Q_PROPERTY(
        qreal relativeMarginRight MEMBER m_relativeMarginRight NOTIFY relativeMarginRightChanged)
    /**
     ...
     */
    Q_PROPERTY(
        qreal relativeMarginBottom MEMBER m_relativeMarginBottom NOTIFY relativeMarginBottomChanged)
    /**
    ...
    /**
     * Maximum additional gap between windows, as a ratio of normal spacing (2*margin). Default
     * is 1.5.
     */
...
protected:
     ...
     */
    QList<QRectF> adjustSizes(const QRectF& minSize,
     ...
     */
    LayeredPacking findGoodPacking(const QRectF& area,
                                   const QList<QRectF>& windowSizes,
     ...
     */
    QList<QRectF> refineAndApplyPacking(const QRectF& area,
                                        const QMarginsF& margins,
